 ...
 */
public abstract class HeronProcessContext<InputT, OutputT, ValueT>
    extends OldDoFn<InputT, OutputT>.ProcessContext {
  private static final Logger LOG = LoggerFactory.getLogger(HeronProcessContext.class);
  ...
  HeronProcessContext(OldDoFn<InputT, OutputT> fn,
    ...
    this.sideInputReader = new HeronSideInputReader(sideInputs);
  ...
  Aggregator<AggregatorInputT, AggregatorOutputT> createAggregatorInternal(
    ...
    throw new UnsupportedOperationException("createAggregatorInternal not yet implemented");
...
//  public abstract Accumulator<NamedAggregators> getAccumulator();
  ...
  public WindowingInternals<InputT, OutputT> windowingInternals() {
    return new WindowingInternals<InputT, OutputT>() {
      ...
      public void outputWindowedValue(
          ...
          PaneInfo paneInfo) {
        HeronProcessContext.this.outputWindowedValue(
      ...
      public <SideOutputT> void sideOutputWindowedValue(
          ...
          Collection<? extends BoundedWindow> windows,
          PaneInfo paneInfo) {
        HeronProcessContext.this.sideOutputWindowedValue(
  ...
  private class ProcCtxtIterator extends AbstractIterator<ValueT> {
      ...
      while (true) {
        if (outputIterator.hasNext()) {
          ...
          if (!calledFinish) {
            ...
            try {
              calledFinish = true;
              doFn.finishBundle(HeronProcessContext.this);
            } catch (Exception e) {
    ...
    private void invokeProcessElement() {
      try {
        doFn.processElement(HeronProcessContext.this);
      } catch (Exception e) {
        handleProcessingException(e);
        throw wrapUserCodeException(e);
      }
